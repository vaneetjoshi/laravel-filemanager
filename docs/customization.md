...
## Views
Copy views to `resources/views/vendor/vaneetjoshi/laravel-filemanager/` :
...
1. Copy `vendor/vaneetjoshi/laravel-filemanager/src/lang/en` to `/resources/lang/vendor/laravel-filemanager/<YOUR LANGUAGE>/lfm.php`.
