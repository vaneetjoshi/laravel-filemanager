...
<head>
  ...
  <style>{!! \File::get(base_path('vendor/vaneetjoshi/laravel-filemanager/public/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script>{!! \File::get(base_path('vendor/vaneetjoshi/laravel-filemanager/public/js/script.js')) !!}</script>
